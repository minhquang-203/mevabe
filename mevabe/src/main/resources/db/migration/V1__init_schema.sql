...
-- Flyway ket noi truc tiep vao database `mevabe_shop` (cau hinh o datasource),
-- nen KHONG can CREATE DATABASE / USE o day.
...
-- Bo DELIMITER (Flyway tu hieu khoi BEGIN...END cua MySQL)
